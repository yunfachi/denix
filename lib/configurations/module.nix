  ...
  module = {
    ...
    imports = [
      ...
      in {
        ...
        imports =
          (apply.listOfEverything (wrap _myconfig.always) (wrap _nixos.always) (wrap _home.always) (wrap _darwin.always))
          ++ (apply.listOfEverything (lib.mkIf enabled (wrap _myconfig.ifEnabled)) (lib.mkIf enabled (wrap _nixos.ifEnabled)) (lib.mkIf enabled (wrap _home.ifEnabled)) (lib.mkIf enabled (wrap _darwin.ifEnabled)))
          ++ (apply.listOfEverything (lib.mkIf disabled (wrap _myconfig.ifDisabled)) (lib.mkIf disabled (wrap _nixos.ifDisabled)) (lib.mkIf disabled (wrap _home.ifDisabled)) (lib.mkIf disabled (wrap _darwin.ifDisabled)));
      })
    ];
  };
}
